...
with open("./assets/ariadne.png", "rb") as ariadne_file:
    ...
    title_html = f"<div style=\"display: flex; justify-content: center; align-items: center; width: 100%; padding: 32px 0 24px 0;\"><h1 style=\"margin: 0; padding: 0; font-size: 2.5rem; font-weight: bold; white-space: nowrap;\"><img src=\"data:image/png;base64,{ariadne_base64}\" style=\"height: 60px; margin-left: 12px; vertical-align: middle;\" /> Agentic Deep Searcher with <span style=\"color: #fb542c;\">Agno</span> &amp; <span style=\"color: #8564ff;\">Scrapegraph</span></h1></div>"
